...
public class JoinListener extends ListenerAdapter {
	...
	public void onGuildMemberJoin(GuildMemberJoinEvent event) {
		...
		builder.addField("Glückwunsch! Aber es gibt ein paar Regeln...",
				...
				+ "**3.**: Werbung für sich und andere Discord-Server wird nur im Channel #eigenwerbung geduldet.\n\n"
		...
		event.getGuild().addRoleToMember(event.getMember(), Exenbot.getNiceOneRole()).queue();
		event.getGuild().addRoleToMember(event.getMember(), Exenbot.getMemberRole()).queue();
